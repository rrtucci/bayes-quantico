...
$n'$ & 0 & 2 & 2 & 4 & 4 & 6 & 6 & 8 & 8 & 10 \\ \hline
$d=2^{n'/2}$ & 1 & 2 & 2 & 4 & 4 & 8 & 8 & 16 & 16 & 32 \\ \hline
\end{tabular}
...
\left\{
\begin{array}
{ll}\gamma_\mu \Gamma =- \Gamma \gamma_\mu
&\text{($n$ even)}
\\
\gamma_\mu \Gamma = \Gamma \gamma_\mu
&\text{($n$ odd)}
\end{array}
\right.
\eeq
...
\quad\text{($n$ odd)}
\eeq
Hence, when $n$ is odd,  the
$\gamma_\mu \in \CC^{n'/2\times n'/2}$ matrices decompose into a pair of conjugate
$\CC^{n'/2\times n'/2}$ reps:
Note that only


When $n$ is even, we can use $\Gamma$ 
to separate the  $\pm$ 
chirality states of a spinor $\psi$
