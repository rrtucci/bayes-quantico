...
\end{tabular}
\caption{Different types of spinors, their number of dofs (real degrees of freedom) in 4D and whether they exist in 4 dim.}
\label{tab-maj-weyl}
\end{table}
...
But in some dimensions, Majorana–Weyl spinors **do** exist 
