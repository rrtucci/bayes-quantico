...
of a group $\calg$ are {\bf equivalent reps} if there is a non-singular matrix $M$ such that
...
\beq
\rho(a):V\rarrow V, \quad
\rho(a)\ket{i}= \sum_{j} \rho(a)_{ij}\ket{j}
\eeq
for all $a\in\calg$.
