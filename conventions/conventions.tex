...
The {\bf Baker-Campbell-Hausdorff}  (BCH) formula is
\beq
e^X e^Y = e^{X + Y + \frac{1}{2}[X,Y]  + \calo(X^aY^b\mid a+b=3)}
\eeq
To prove it, one just expands the exponentials on both sides, neglecting
 terms $X^a Y^b$ where $a+b\geq 3$.
...
\section{Lie Algebra Representation}
...
\beq
\left[\frac{d}{dX_1}, \frac{d}{dX_2}\right]=
\frac{d}{d[X_1,X_2]}
\eeq
...
\beqa
\left[\frac{d}{dX_1}, \frac{d}{dX_2}\right](Y) &=&
\frac{d}{dX_1}\frac{d}{dX_2}Y
-
\frac{d}{dX_2}\frac{d}{dX_1}Y
\\
&=&
[X_1,[X_2, Y]]-
[X_2, [X_1, Y]]
...
\beqa
\lim_{\eps\rarrow 0}
\frac{1}{\eps}\left(Ad[\eps X]-1\right)Y&=&\lim_{\eps\rarrow 0}
\frac{1}{\eps}[(1+\eps X)Y(1-\eps X)-Y]
\\
&=&
[X, Y]=
\frac{d}{dX}(Y)=ad[X](Y)
