...
\beq
\myboxed{
f\indices{_a_c} f\indices{^c ^b}=-\delta_a^b}
\quad
\xymatrix{
&\ul{f}
\ar[l]\ar[r]
...
$f$. Those f-decorations are redundant. Not using those decorations
...
\ecen
\eeq
We will also use\footnote{We repeat again: the decorated $f$'s in these birdtracks are redundant and only included for the sake of clarity. The direction of
