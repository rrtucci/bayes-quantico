...
Complexifying collapses this
classification
of representations to a far simpler one . In fact, the representations of $Cl(n)_\CC$ are all complex.
...
\item If $n$ is even, and $V=\CC^{n/2}$,
then
...
quaternions is the
same as that of Pauli matrices, 
if we map
