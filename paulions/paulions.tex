...
gamma matrices are easy to discuss and construct, and we discuss them next.
They are the ones used in Quantum Electodynamics and the Dirac equation. 

Real representations of the gamma
 matrices are much harder to
construct, so we won't discuss them here. They are characterized by 
...
If we use complex gamma matrices,
then spinors are complex. 
This causes a bit of confusion to
beginners because even though the the spinor has complex entries even though the
definition of the group $Spin(n)$ uses only real matrices on the basis of gamma matrix products.
