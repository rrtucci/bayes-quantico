...
for $\mu=1,2,\ldots,n$ (this assumes the Euclidean metric which is $(1, 1, 1, 1)$ for $n=4$)
\beq
Spin(n)_\RR=
\{e^{\omega^{\mu\nu}\gamma_{\mu\nu}}|
\omega_{\mu\nu}=-\omega_{\nu\mu}\in\RR\}
...
$\gamma_i^\dagger=-\gamma_i$ (this assumes the mostly-minus metric which is $(1, -1, -1, -1)$ for $n=4$)
\beq
Spin(1,3)_\RR=
\{e^{-i\omega^{\mu\nu}\gamma_{\mu\nu}}|
\omega_{\mu\nu}=-\omega_{\nu\mu},
