...
Where $\eta_{\mu\nu}$ is real valued\footnote{Since $\eta_{\mu\nu}$ is real, we consider $Cl(n)_\RR$ instead of iits complexification $Cl(n)_\CC$} For $n=4$, it equals the Euclidean metric $(1,1,1,1)$ or the Lorentzian metric $(1, -1,-1,-1)$.
...
is equal to $2^n$ in every case.  For
...
Complexifying collapses this to the simpler classification
of representations. In fact, the representations of $Cl(n)_\CC$ are all complex.
