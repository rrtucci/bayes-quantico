...
\section{Relation of weights of WD to Standard Young Tableau}



Given a young diagram YD, a sSYT (Semi  Standard Young Tableau) 
for the YD satisfies


\begin{itemize}
\item Rows weakly increasing
