...
Suppose $\ger{g}$ is the Lie algebra of a group $\calg$.
Note that an irrep of $\calg$ always gives an irrep of $\ger{g}$,
but an irrep of $\ger{g}$ might not give an irrep of $\calg$.
Suppose groups $\calg_1$ and $\calg_2$ with different global topology both have Lie algebra $\ger{g}$.
Some irreps of $\ger{g}$ might lead to irreps of $\calg_1$ but not of $\calg_2$.
