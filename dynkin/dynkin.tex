...
From the properties of commutator bracket\footnote{The commutator $[x,y]=xy-yx$ acts like a derivative operator: 
$ [x[a,b]]= [[x,a],b] + 
[a,[x,b]]$}
...
\beq
\boxed{[E_\valp,
E_{-\valp}] = \sum_{i_-} f_{\valp,-\valp,i_-}H_{i_-}}
\eeq
...
\item relative lengths constraint
...
Using the angle and length constraints on SP roots and
the definition of SP roots,
...
\begin{enumerate}
\item One dot for each SP root. $n$ subscript in $A_n, B_n, C_n, D_n$
is number of dots
