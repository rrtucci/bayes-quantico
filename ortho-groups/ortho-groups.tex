...
$g$. Those g-decorations are redundant. Not using those decorations
...
\ecen
\eeq
We will also use\footnote{We repeat again: the decorated $g$'s in these birdtracks are redundant and only included for the sake of clarity. The direction of
the arrows has that info already.}
...
are anti-symmetric ($T_i^T=-T_i$)\footnote{For similar
reasons, the generators of $U(n)$
are Hermitian.}
