...
For any matrix rep-matrix $G_\lam$ in rep $\lam$ such that $G_\lam$
...
Note that $d_\cals= 1$ iff $n=1$, and $d_\cala=1$ iff $n=2$. Therefore,
for $SU(n)$
...
\ecen
=\pi_\cals + \pi_\cala + \text{ non-singlet projectors}
\eeq
Hence
