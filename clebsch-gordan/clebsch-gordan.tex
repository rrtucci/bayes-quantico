...
Below, we will
define matrices $C_\lam$ and $C^\dagger_\lam$.
...
$C_\lam$ as a rounded 
out bra $\bra{x}$
and of $C^\dagger_\lam$
as the corresponding ket $\ket{x}$},
then $C_\lam$ and $C_\lam ^\dagger$
satisfy identities
similar to those satisfied by $\ket{x}$ and $\bra{x}$. 
We will show that
in this chapter.
...
\beq
P_\lam C= P_\lam C_\lam,\quad
C^\dagger P_\lam = 
C^\dagger_\lam P_\lam
\eeq

\beqa
C_\lam  C^\dagger_\lam &=&
P_\lam C C^\dagger P_\lam
\\
&=&
P_\lam
\eeqa
...
\\
&=& 
C^\dagger\left(\sum_\lam \lam P_\lam 
\right)C
\\
&=&\sum_\lam
\lam C^\dagger_\lam
...
\\
&=&
 \sum_\lam C^\dagger P_\lam C
\\
&=&
 \sum_\lam C^\dagger_\lam  C_\lam
