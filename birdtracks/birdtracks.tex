...
Birdtracks are a 
DAG used to represent tensor equations. 
The labelled nodes of the DAG
are the tensors and the 
labelled arrows are the indices of 
...
we must specify on the node, which arrow is first,
and then the CC 
order in which
the arrows 
...
All orders are all equivalent. This is
...
be consistent 
with causality,
this hints to the acausal
(or feedback) nature of tracing.
