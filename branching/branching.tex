...
Let $n=p+q$\footnote{Note that given two groups $G_1$, $G_2$,
their Cartesian product $G_1\times G_2$ is defined, but 
not their direct sum $G_1\oplus G_2$
or direct (Kronecker) product $G_1\otimes G_2$. Direct sums and products are defined for vectors (and vector spaces) and matrices (and matrix  reps).}
